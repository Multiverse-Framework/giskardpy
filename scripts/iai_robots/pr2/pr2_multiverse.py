...
from giskardpy.configs.iai_robots.pr2 import PR2CollisionAvoidance, PR2JointTrajServerMultiverseInterface, \
    WorldWithPR2Config
...
if __name__ == '__main__':
    ...
    giskard = Giskard(world_config=WorldWithPR2Config(),
                      ...
                      robot_interface_config=PR2JointTrajServerMultiverseInterface(),
